...
// |                             Пакет (до 263 байт)                               |
// +------------------+------------------------------------------------------------+
// |                  |            Данные пакета (до 255 байт)                     |
// |                  +------------------------------------------------------+-----+
// |                  |      Зашифрованое сообщение (до 253 байт)            |     |
// | Заголовок пакета +-------------+----------------------------------------+     |
// |    (4-8 байт)    |  Заголовок  | Расшифрованое сообщение ( до 249 байт) | CRC |
// |                  | шифрограммы +---------------------+------------------+ (2) |
// |                  | (0-4 байта) | Заголовок сообщения | Данные сообщения |     |
// |                  |             |     (2-4 байта)     |  (до 247 байт)   |     |
// +------------------+-------------+---------------------+------------------+-----+
...
#define IRIDIUM_BUS_MAX_HEADER_SIZE    8
